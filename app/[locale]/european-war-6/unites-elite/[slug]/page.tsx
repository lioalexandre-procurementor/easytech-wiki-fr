      ...
      <div className="max-w-[1320px] mx-auto px-3 md:px-6 pb-20 lg:grid lg:grid-cols-[240px_1fr] lg:gap-7">
        <aside className="hidden lg:block bg-panel border border-border rounded-lg p-4 h-fit lg:sticky lg:top-20">
          ...
          <ul className="list-none text-sm">
            {sidebarUnits.map(u => (
              <li key={u.slug}>
                <Link href={{ pathname: "/european-war-6/unites-elite/[slug]", params: { slug: u.slug } }}
          ...
          {sameCat.length > 0 && (
            <>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {sameCat.map(u => (
                  <Link key={u.slug} href={{ pathname: "/european-war-6/unites-elite/[slug]", params: { slug: u.slug } }}
