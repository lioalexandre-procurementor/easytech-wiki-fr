    ...
    alternates: {
      canonical:
        locale === "fr"
          ...
          : `/${locale}/european-war-6/updates`,
      languages: {
        fr: "/fr/european-war-6/mises-a-jour",
        en: "/en/european-war-6/updates",
        de: "/de/european-war-6/updates",
        "x-default": "/fr/european-war-6/mises-a-jour",
      },
    },
    openGraph: {
      title: t("seoTitle"),
        ...
        {updates.length === 0 ? (
          ...
          <div className="grid gap-4">
            {updates.map((u) => (
              <Link
                key={u.slug}
                href={`/european-war-6/mises-a-jour/${u.slug}` as any}
