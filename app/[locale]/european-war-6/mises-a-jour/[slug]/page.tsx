    ...
    alternates: {
      canonical:
        locale === "fr"
          ...
          : `/${locale}/european-war-6/updates/${slug}`,
      languages: {
        fr: `/fr/european-war-6/mises-a-jour/${slug}`,
        en: `/en/european-war-6/updates/${slug}`,
        de: `/de/european-war-6/updates/${slug}`,
        "x-default": `/fr/european-war-6/mises-a-jour/${slug}`,
      },
    },
    openGraph: {
      title: t("detailSeoTitle", { title: u.title[loc] }),
  ...
  return (
    <>
      ...
      <div className="max-w-[860px] mx-auto px-6 py-3.5 text-xs text-muted">
        ...
        <span className="mx-2 text-border">{t("breadcrumb.separator")}</span>
        <Link
          href={"/european-war-6/mises-a-jour" as any}
          className="text-dim"
        >
