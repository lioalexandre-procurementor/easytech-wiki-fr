...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/european-war-6/guides/${slug}`,
      languages: {
        fr: `/fr/european-war-6/guides/${slug}`,
        en: `/en/european-war-6/guides/${slug}`,
        de: `/de/european-war-6/guides/${slug}`,
        "x-default": `/fr/european-war-6/guides/${slug}`,
      },
    },
    openGraph: {
      title: g.title[loc],
    ...
    itemListElement: [
      {
        ...
        item: `https://easytech-wiki.com/${locale}/european-war-6`,
      },
      {
        "@type": "ListItem",
        position: 2,
        name: t("guidesPage.hubTitle"),
        item: `https://easytech-wiki.com/${locale}/european-war-6/guides`,
      },
      {
        "@type": "ListItem",
        position: 3,
        name: guide.title[loc],
        item: `https://easytech-wiki.com/${locale}/european-war-6/guides/${slug}`,
      },
    ],
  };
  ...
  return (
    <>
      ...
      <article className="max-w-[860px] mx-auto px-4 md:px-6 pb-20">
        ...
        >
          <Link href={"/european-war-6" as any} className="hover:text-gold2">
            GCR
          </Link>
          <span aria-hidden="true">›</span>
          <Link href={"/european-war-6/guides" as any} className="hover:text-gold2">
