    ...
    <>
      ...
      <div className="max-w-[1320px] mx-auto px-6 pb-20">
        <main>
          <PageHero
            className="mb-6"
            eyebrow="World Conqueror 4 · 1939 — 1945"
            title={t("wc4Hub.h1")}
            subtitle={t("wc4Hub.tagline")}
          >
            <div className="flex flex-wrap gap-2.5">
              ...
              <Link href="/world-conqueror-4/guides"
                className="inline-flex items-center gap-2 bg-transparent text-ink hover:text-gold2 px-6 py-3 rounded-lg font-semibold text-sm no-underline border border-border hover:border-gold transition-colors">
                {t("wc4Hub.ctaBeginner")} →
              </Link>
            </div>
            <div className="flex flex-wrap gap-x-8 gap-y-4 mt-7">
              <HeroStat n={standardUnits.length} l={t("wc4Hub.statEliteUnits")}/>
              <HeroStat n={scorpionUnits.length} l={t("wc4Hub.statScorpionUnits")}/>
              <HeroStat n={generals.length} l={t("wc4Hub.statGenerals")}/>
              <HeroStat n={t("wc4Hub.statMaxLevelsValue")} l={t("wc4Hub.statMaxLevels")}/>
            </div>
          </PageHero>

          <p className="flex items-start gap-2 text-amber-200/90 text-xs mb-6 px-1">
          ...
          <h2 className="text-2xl font-extrabold text-ink mb-4 mt-10">{t("wc4Hub.mostViewed")}</h2>
