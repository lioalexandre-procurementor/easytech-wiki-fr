      ...
      <div className="max-w-[1320px] mx-auto px-6 pb-20 grid lg:grid-cols-[240px_1fr] gap-7">
        <aside className="hidden lg:block bg-panel border border-border rounded-lg p-4 h-fit lg:sticky lg:top-20">
          ...
          <ul className="list-none text-sm">
            ...
            {barbarian && (
              <li><Link href="/great-conqueror-rome/conquete-romaine" className="block px-2 py-1 text-dim no-underline hover:text-gold2">⚔ {t("nav.barbarian")}</Link></li>
            )}
          </ul>
        </aside>
            ...
            <div id="units" className="bg-panel border border-border rounded-lg p-6 mb-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {recommended.map((u) => (
                  <Link
                    key={u.slug}
                    href={{ pathname: "/great-conqueror-rome/unites-elite/[slug]", params: { slug: u.slug } }}
            ...
            <>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {related.map((r) => (
                  <Link
                    key={r.slug}
                    href={{ pathname: "/great-conqueror-rome/generaux/[slug]", params: { slug: r.slug } }}
