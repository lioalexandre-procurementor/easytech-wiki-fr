...
import { getAllTechSlugs, getTech } from "@/lib/gcr";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/great-conqueror-rome/technologies/${slug}`,
      languages: {
        fr: `/fr/great-conqueror-rome/technologies/${slug}`,
        en: `/en/great-conqueror-rome/technologies/${slug}`,
        de: `/de/great-conqueror-rome/technologies/${slug}`,
        "x-default": `/fr/great-conqueror-rome/technologies/${slug}`,
      },
    },
    ...
    <>
      ...
      <div className="max-w-[1320px] mx-auto px-6 pb-20">
        <nav className="mt-4 mb-5">
          <Link
            href={"/great-conqueror-rome/technologies" as any}
