...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/great-conqueror-rome/technologies`,
      languages: {
        fr: "/fr/great-conqueror-rome/technologies",
        en: "/en/great-conqueror-rome/technologies",
        de: "/de/great-conqueror-rome/technologies",
        "x-default": "/fr/great-conqueror-rome/technologies",
      },
    },
    openGraph: {
      title: t("seoTitle"),
    ...
    <>
      ...
      <div className="max-w-[1320px] mx-auto px-4 md:px-6 pb-20">
        <nav className="mt-4 mb-5">
          <Link
            href={"/great-conqueror-rome" as any}
