...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/great-conqueror-rome/guides/${slug}`,
      languages: {
        fr: `/fr/great-conqueror-rome/guides/${slug}`,
        en: `/en/great-conqueror-rome/guides/${slug}`,
        de: `/de/great-conqueror-rome/guides/${slug}`,
        "x-default": `/fr/great-conqueror-rome/guides/${slug}`,
      },
    },
    openGraph: {
      title: g.title[loc],
    ...
    itemListElement: [
      {
        ...
        item: `https://easytech-wiki.com/${locale}/great-conqueror-rome`,
      },
      {
        "@type": "ListItem",
        position: 2,
        name: t("guidesPage.hubTitle"),
        item: `https://easytech-wiki.com/${locale}/great-conqueror-rome/guides`,
      },
      {
        "@type": "ListItem",
        position: 3,
        name: guide.title[loc],
        item: `https://easytech-wiki.com/${locale}/great-conqueror-rome/guides/${slug}`,
      },
    ],
  };
  ...
  return (
    <>
      ...
      <article className="max-w-[860px] mx-auto px-4 md:px-6 pb-20">
        ...
        >
          <Link href={"/great-conqueror-rome" as any} className="hover:text-gold2">
            GCR
          </Link>
          <span aria-hidden="true">›</span>
          <Link href={"/great-conqueror-rome/guides" as any} className="hover:text-gold2">
        ...
        <header className="mb-6">
          {/* Hero image — GCR-themed, falls back to category-colored gradient */}
          {guide.heroImage ? (
            <div
