...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/great-conqueror-rome/guides`,
      languages: {
        fr: "/fr/great-conqueror-rome/guides",
        en: "/en/great-conqueror-rome/guides",
        de: "/de/great-conqueror-rome/guides",
        "x-default": "/fr/great-conqueror-rome/guides",
      },
    },
    openGraph: {
      title: t("seoTitle"),
        ...
        <div className="grid gap-4 md:gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {guides.map((g) => {
            ...
            return (
              <Link
                key={g.slug}
                href={`/great-conqueror-rome/guides/${g.slug}` as any}
