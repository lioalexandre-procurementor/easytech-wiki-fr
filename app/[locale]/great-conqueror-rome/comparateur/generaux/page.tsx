...
import { getAllGenerals } from "@/lib/gcr";
import {
  buildTrainedView,
    ...
    alternates: {
      canonical:
        locale === "fr"
          ...
          : `/${locale}/great-conqueror-rome/comparator/generals`,
      languages: {
        fr: "/fr/great-conqueror-rome/comparateur/generaux",
        en: "/en/great-conqueror-rome/comparator/generals",
        de: "/de/great-conqueror-rome/comparator/generals",
        "x-default": "/fr/great-conqueror-rome/comparateur/generaux",
      },
    },
    openGraph: {
...
function generalToRow(g: GeneralData, mode: CompareMode): ComparableRow | null {
  ...
  return {
    ...
    href: {
      fr: `/great-conqueror-rome/generaux/${g.slug}`,
      en: `/great-conqueror-rome/generals/${g.slug}`,
      de: `/great-conqueror-rome/generals/${g.slug}`,
    },
  };
}
