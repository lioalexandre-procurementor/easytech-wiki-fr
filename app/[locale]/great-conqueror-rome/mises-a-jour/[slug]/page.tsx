    ...
    alternates: {
      canonical:
        locale === "fr"
          ...
          : `/${locale}/great-conqueror-rome/updates/${slug}`,
      languages: {
        fr: `/fr/great-conqueror-rome/mises-a-jour/${slug}`,
        en: `/en/great-conqueror-rome/updates/${slug}`,
        de: `/de/great-conqueror-rome/updates/${slug}`,
        "x-default": `/fr/great-conqueror-rome/mises-a-jour/${slug}`,
      },
    },
    openGraph: {
      title: t("detailSeoTitle", { title: u.title[loc] }),
  ...
  return (
    <>
      ...
      <div className="max-w-[860px] mx-auto px-6 py-3.5 text-xs text-muted">
        ...
        <span className="mx-2 text-border">{t("breadcrumb.separator")}</span>
        <Link
          href={"/great-conqueror-rome/mises-a-jour" as any}
          className="text-dim"
        >
